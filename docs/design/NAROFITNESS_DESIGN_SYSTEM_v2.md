...
- [`docs/product/planning/TASK_HISTORY.md`](../control/TASK_HISTORY.md) — durable closure and recovery history
- [`docs/product/planning/APP_WIDE_UX_SCOPE.md`](../control/APP_WIDE_UX_SCOPE.md) — Theme v2 implementation record
