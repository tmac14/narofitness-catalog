...
|---|---|---|---|---|
| EVID-CTRL-001 | CODEX-RECOVERY-RUNBOOK-AND-STATE-CONTROL | PASS | Recovery bootstrap and limited live-state update boundary exist. | `docs/coordination/CODEX_RECOVERY_RUNBOOK.md` |
