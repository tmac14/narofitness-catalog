...
- `docs/product/planning/tasks/CATALOGUE-BUILDER-OPEN-QA.md` for remaining catalogue-builder QA
...
- `docs/product/planning/contracts/API-1_VALIDATION_CHECKLIST.md` — Agent 2 checklist
