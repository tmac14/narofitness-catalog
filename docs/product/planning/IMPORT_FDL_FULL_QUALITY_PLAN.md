...
**Registry:** [IMPORT_PARSER_BACKLOG.md](./IMPORT_PARSER_BACKLOG.md) · [planning state.md](./planning state.md)
...
| **Catalog UI agent** | **Idle** until backend stabilized — then Products UI visual smoke only |
...
| Catalog builder visual smoke | Catalog UI agent |
...
| **Catalog UI agent** | **Idle** (Wave 2 smoke only when stable) |
| **Agent 4** | **Idle** |
