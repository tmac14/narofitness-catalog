...
- `docs/control/tasks/CATALOGUE-BUILDER-OPEN-QA.md` for remaining catalogue-builder QA
...
- `docs/control/contracts/API-1_VALIDATION_CHECKLIST.md` — Agent 2 checklist
