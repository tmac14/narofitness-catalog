...
| Taxonomy / grouping / review | `run_preview_pipeline` | Same modules, manual orchestration |
...
| **User / Agent 1B** | Optional visual QA on import review UI (`family_header_raw`, brand fields in `parsed_payload`) |
