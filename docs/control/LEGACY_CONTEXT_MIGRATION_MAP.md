...
|---|---|---|
| Monolithic chat handoff and rationale snapshot | `PROFILE.md`, engineering standards, protocols, live state, registry, history, import plan/evidence | Fully consolidated; not required for recovery |
