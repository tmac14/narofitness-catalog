...
material task-state transitions under the limited permission in `PROFILE.md`.
...
**Source docs:** `PROFILE.md`, `docs/control/CONTROL_PLANE_RECOVERY_RUNBOOK.md`, `docs/control/TASK_EXECUTION_PROTOCOL.md`, `docs/control/TASK_REGISTRY.yaml`, `docs/control/AGENT_REGISTRY.yaml`, `docs/control/DECISION_LOG.md`, `docs/control/EVIDENCE_INDEX.md`, selected execution protocol, `COMMANDS.md`
...
`PROFILE.md` without separate documentation permission after a material task-state
...
- Task/lock/dependency authority: `docs/control/TASK_REGISTRY.yaml`
- Agent capability/topology authority:
  `docs/control/AGENT_REGISTRY.yaml`
- Active task packet: `docs/control/tasks/APP-PLATFORM-UX-3.0-PHASE-2D.md`
- Planning and parallel-safety gate:
  `docs/control/TASK_EXECUTION_PROTOCOL.md`
...
- **Closeout packet:** `docs/control/tasks/ORDIA-D022-MODEL-ROUTING-V07-CLOSEOUT.md`
...
Authoritative details: `docs/control/TASK_REGISTRY.yaml`.
