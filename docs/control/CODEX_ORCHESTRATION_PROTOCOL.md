...
- Modify documentation only when explicitly in scope or under the limited
  control-update permission in `PROFILE.md`.
...
Profile overlay (Narofitness): `import_regression`, `import_page_audit`, `topology_review` — see `docs/control/workflows/intents.narofitness.yaml`.
