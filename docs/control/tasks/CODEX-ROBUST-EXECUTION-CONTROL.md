...
- Allowed: `AGENTS.md`, `docs/control/**`
...
- Actual files changed:
  ...
  - `docs/control/CODEX_SELF_IMPLEMENTATION_PROTOCOL.md`
  - `docs/control/CODEX_ORCHESTRATION_PROTOCOL.md`
  - `docs/control/tasks/README.md`
