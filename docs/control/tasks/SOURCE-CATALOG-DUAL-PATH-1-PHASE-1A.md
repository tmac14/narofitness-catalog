...
- `docs/control/SOURCE_CATALOG_DUAL_PATH_PLAN.md`
- `docs/control/SOURCE_CATALOG_PHASE0_DECISIONS.md`
- `docs/control/SOURCE_CATALOG_PHASE1A_BATCH_PLAN.md`
- `docs/control/SOURCE_CATALOG_PHASE1A_PAUSE_CHECKPOINT.md`
- `docs/control/contracts/SOURCE_DOCUMENT_ANALYSIS_V1_CONTRACT.md`
