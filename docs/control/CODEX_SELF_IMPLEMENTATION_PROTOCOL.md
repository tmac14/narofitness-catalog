...
1. `docs/control/ORCHESTRATION_STATE.md`
2. `docs/control/CONTROL_PLANE_RECOVERY_RUNBOOK.md`
3. `docs/control/TASK_EXECUTION_PROTOCOL.md`
4. `docs/control/TASK_REGISTRY.yaml`
5. `docs/control/AGENT_REGISTRY.yaml`
...
- Modify coordination documentation only within approved scope or under the
  limited control-update permission in `PROFILE.md`.
...
- Limited exception: after a material state transition, Codex may update the
  control documents authorized by `PROFILE.md`.
