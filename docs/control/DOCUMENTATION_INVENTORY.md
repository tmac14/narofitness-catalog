...
|---|---|---|---|
| `PROFILE.md` | CORE | English | Keep; Narofitness domain profile (Ordia v0.9 scaffold) |
| `COMMANDS.md` | CORE | English | Keep; canonical npm command overlay |
| `commands.catalog.json` | CORE | English | Keep; command catalog (sync with package.json) |
...
| `docs/control/workflows/intents.narofitness.yaml` | ACTIVE | English | Keep; Narofitness workflow intent overlay (ORDIA-D023) |
